...
# Creating 6 nodes 
echo "### Creating nodes ..."
docker-machine create --driver google --google-project $GOOGLE_CLOUD_PROJECT --google-zone europe-west3-b swarm-manager
for c in {1..2} ; do
    docker-machine create --driver google --google-project $GOOGLE_CLOUD_PROJECT --google-zone europe-west3-b swarm-noeud$c
done
